var config = {
    token: "ODkzODI1ODcxMzkwMDU2NDgw.GxlzjB.RMdta_FMZnFNWXugjy3sWzwhv67KWUrRjMSZBQ", // Replace this with you bot account's token. | https://discordjs.guide/preparations/setting-up-a-bot-application.html
